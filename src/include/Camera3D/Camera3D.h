...
// Code extracted from https://learnopengl.com/code_viewer_gh.php?code=includes/learnopengl/camera.h
//

#ifndef N_BODY_CAMERA3D_H
#define N_BODY_CAMERA3D_H
