...
std::unique_ptr<ParticleSystem> ParticleSystemLagrange::generateParticles(glm::vec3 worldDimensions) {
	...
	particles.push_back(Particle(vertex1, glm::vec3(0), mass));
	particles.push_back(Particle(vertex2, glm::vec3(0), mass));
	particles.push_back(Particle(vertex3, glm::vec3(0), mass));
