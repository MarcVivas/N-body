...
std::unique_ptr<ParticleSystem> ParticleSystemGalaxyInitializer::generateParticles(glm::vec3 worldDimensions) {
	std::vector<Particle> particles;
	particles.reserve(this->totalParticles); // Reserve space for the particles
